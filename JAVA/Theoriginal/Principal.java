    ...
    public static void CapturaVentaProducto(String[][] mticket, String[][] mproductos, String idticket, int tamticket) throws IOException {
        ...
        if (codigo != null) {
            ...
            if (posp > -1) {
                ...
                System.out.println("El código no existe, no se puede agregar\n");
            }
        } else {
            System.out.println("Dato nulo\n");
        }
    ...
    if (posicion > -1) {
      ...
      if (cantidad != null) {
        if (EvaluarNumerico(cantidad, 2) || EvaluarNumerico(cantidad, 1)) {
          String nuevacantidad = String.valueOf(
            (Integer.valueOf(cantidad) + Integer.valueOf(vproductos[posicion][3]))
          );
